(function () {
    ...
    T.Load('./parts/index/InComeTemp.html', "#dt1", function () {
        ...
        var api = [
            //收入按组织
            'api/query_in_come_by_unit.json',
            //收入按时间
            'api/query_in_come_by_time.json',
            //收入按业务
            'api/query_in_come_by_item.json',
            //收入按当月组织
            'api/query_in_come.json',
            //获取itemId
        ...
        p1.then(function (itemId) {
            var vm = new Vue({
                ...
                data: {
                    ...
                    //列表数据
                    inComeList: [
                        // {"name":"新城首府","target":10,"reach":5.2,"reachRate":"36%"},
                    ],
                    //列表下面点击按钮
                    bottomBtnData: {
                        "text": "展开全部",
                ...
                methods: {
                    ...
                    tabStore: function (index) {
                        ...
                        if (this.bottomFlag === 0 || this.bottomFlag === 2) {
                            ...
                            // T.AllData.commonParams.monthYear=index+1;
                        } else {
                            //分月  1   累计  2
                            this.monthTotal = index + 1;
                            // T.AllData.commonParams.monthTotal=index+1;
                        }
                        this.bottomBtnData = {
                            "text": "展开全部",
                            "bSign": true,
                    ...
                    echarts: function () {
                        var _this = this;
                        var nhCharts = echarts.init(document.getElementById('in_come_nhCharts'));
                        ...
                        var option = {
                            ...
                            dataZoom: [
                                {
                                    type: this.bottomFlag === 1 || this.inComeList.length <= 12 ? 'inside' : 'slider',//inside----slider
                                    zoomLock: true,
                                    startValue: 0,
...
//									}
                    ...
                    xaxisDataChange: function (val) {
                        ...
                        document.getElementById('in_come_nhCharts_box').style.height = 6 + (n * 18 / 100) + 'rem';
            ...
            function this_ref () {
                var dataName;
                if (T.AllData.InCome.dataName !== undefined) {
                    dataName = T.AllData.InCome.dataName;
                    arr = dataName.arr;
